...
class VGG(nn.Module):
    ...
    def __init__(self, cfg, batch_norm=False, num_classes=1000):
        ...
        self.classifier = nn.Linear([item for sublist in cfg for item in sublist][-1], num_classes)
...
cfg = {
    ...
    'XS': [[32], [64], [128], [256], [256]],
    'XXS': [[16], [32], [64], [128], [128]],
    'XXXS': [[8], [16], [32], [64], [64]],
    'XXXXS': [[4], [8], [16], [32], [32]],
    'XXXXXS': [[2], [4], [8], [16], [16]],
    ########################################
...
# XS #
def vgg_xs(**kwargs):
    """VGG 8-layer model (configuration "XS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XS'], **kwargs)
    return model
...
def vggxs_bn(**kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XS'], batch_norm=True, **kwargs)
    return model

# XXS #
def vgg_2xs(**kwargs):
    """VGG 8-layer model (configuration "XXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXS'], **kwargs)
    return model


def vgg2xs_bn(**kwargs):
    """VGG 8-layer model (configuration "XXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXS'], batch_norm=True, **kwargs)
    return model

# XXXS #
def vgg_3xs(**kwargs):
    """VGG 8-layer model (configuration "XXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXS'], **kwargs)
    return model


def vgg3xs_bn(**kwargs):
    """VGG 8-layer model (configuration "XXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXS'], batch_norm=True, **kwargs)
    return model

# XXXXS #
def vgg_4xs(**kwargs):
    """VGG 8-layer model (configuration "XXXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXXS'], **kwargs)
    return model


def vgg4xs_bn(**kwargs):
    """VGG 8-layer model (configuration "XXXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXXS'], batch_norm=True, **kwargs)
    return model

# XXXXXS #
def vgg_5xs(**kwargs):
    """VGG 8-layer model (configuration "XXXXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXXXS'], **kwargs)
    return model


def vgg5xs_bn(**kwargs):
    """VGG 8-layer model (configuration "XXXXXS")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['XXXXXS'], batch_norm=True, **kwargs)
    return model
